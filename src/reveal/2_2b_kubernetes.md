...
<img src="static/img/sdd-logo.png" width="10%" height=auto>
...
![distributed](static/img/k8s-distributed-systems.png) 

<!--s-->

## Microservice Design

![microservices](static/img/monolithic-vs-microservices.png)
...
![pod](static/img/k8s-pod.png)<!-- .element: height="50%" width="50%" -->
...
![deployment](static/img/k8s-deployment.png)<!-- .element: height="50%" width="50%" -->

<!--s-->

## Pod, Deployment configuration

![pod-config](static/img/k8s-deployment-spec.png)<!-- .element: height="50%" width="50%" -->

<!--s-->

## Updating Deployments

![deployment-update](static/img/k8s-deployment-update.png)<!-- .element: height="50%" width="50%" -->
...
![service](static/img/k8s-service.png)<!-- .element: height="50%" width="50%" -->

<!--s-->

## Service Configuration

![service-config](static/img/k8s-service-spec.png)<!-- .element: height="50%" width="50%" -->
...
![ingress](static/img/k8s-ingress.png)<!-- .element: height="50%" width="50%" -->

<!--s-->

## Ingress Configuration

![ingress-config](static/img/k8s-ingress-spec.png)
...
![job-config](static/img/k8s-job-spec.png)
...
![control](static/img/k8s-master-node.png)

<!--s-->

## Kubernetes System

![system](static/img/k8s-full-architecture.png)
