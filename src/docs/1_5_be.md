...
The best way to run this BE is to setup a Github Codespace VM and install the google cloud sdk. Refer to the previous [hands-on](1_3_gcp_handson.html) to learn more
...
![access2](https://storage.googleapis.com/fchouteau-isae-cloud/be/gcp_project_access_2.png)
...
- Ensure that the google cloud sdk is installed and configured (it should be done automatically)

to the `sdd2324` project
...
#### 1.3.3 - Pull Docker Images from your teammates
...
* Select another mascot and [pull the corresponding docker image from the registry](1_4_docker_tp.md#1-manipulating-docker-for-the-1st-time)
